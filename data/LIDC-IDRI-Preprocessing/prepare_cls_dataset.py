...
from utils import is_dir_path,segment_lung, normalize
        ...
        for patient in tqdm(self.IDRI_list):
            ...
            if len(nodules_annotation) > 0:
                ...
                # This current for loop iterates over total number of nodules in a single patient
                    ...
                    for nodule_slice in range(cbbox[2].stop - cbbox[2].start):

                        nodule_slice_np_array = normalize(nodule_np_array[:,:,nodule_slice])
                        # I am not sure why but some values are stored as -0. <- this may result in datatype error in pytorch training # Not sure
                        nodule_slice_np_array[nodule_slice_np_array==-0] =0
                        ...
                        np.save(patient_image_dir / nodule_name,nodule_slice_np_array)
