...
class UNetPlusPlus_cls(nn.Module):
    def __init__(self, in_channels, base_channels, n_classes, number_unet, 
        ...
        super(UNetPlusPlus_cls, self).__init__()
        ...
        self.output_pooling = nn.AvgPool2d(kernel_size=64)
    ...
    def forward(self, input):
        ...
        output = self.output_pooling(output)
...
if __name__ == "__main__":
    ...
    @hydra.main(version_base=None, config_path=config_path, config_name="unetplusplus_cls_module.yaml")
